...
const timerId = setTimeout(greetUser, 2000, "Dmitro", "Hello");
...
const intervalIDNumber = setInterval(greetUserTwo, 1000, "Alex", "Hello");
 ...
 */
let timeStamp = 2000;
const timerRecID = setTimeout(function firstTimer() {
    if (timeStamp > 6000) {
        return;
    }
